...
const Description = ({ index }) => {
  const card = [
    ...
    },
    {
      ...
      paragraph:
        "Our modern furniture store provide high level of quality. Our company has invested in advanced technology to ensure that every product is made as perfect and as consistent as possible. With three decades of experience in this industry, we understand what customers want for their home and office.",
    },
  ];
  ...
  return (
    <div
      key={card[index].id}
      className="home__discover-description c-card-description"
    >
      <h2 className="home__discover-title animate">{card[index].title}</h2>
      <p className="home__discover-paragraph c-card-paragraph animate">
